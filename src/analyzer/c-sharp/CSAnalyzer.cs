...
namespace protoextractor.analyzer.c_sharp
{
    class CSAnalyzer : DefaultAnalyzer
    {
        ...
        // Public child classes will be pushed onto the namespace of the parent.
        ...
        public override DefaultAnalyzer Parse()
        {
            ...
            foreach (var assemblyFileName in analyzableFiles)
            {
                ...
                AssemblyDefinition ass = AssemblyDefinition.ReadAssembly(assemblyFileName, _resolverParameters);
                // And process..
                AnalyzeAssembly(ass);
            }
